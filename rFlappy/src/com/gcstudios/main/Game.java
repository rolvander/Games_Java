...
import com.gcstudios.entities.Mato;
...
public class Game extends Canvas implements Runnable,KeyListener,MouseListener,MouseMotionListener{
	...
	public Game(){
		...
		ui = new UI();
		mato = new Mato(0, 0, WIDTH, HEIGHT, 1, Game.spritesheet.getSprite(16, 0, 32, 32));
