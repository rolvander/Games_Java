...
public class Game extends Canvas implements Runnable,KeyListener,MouseListener,MouseMotionListener{
	...
	public static int fruta_atual;
	public static int fruta_contagem;
	public static int orange_contagem;
	public static int orange_atual;
	
	public static int comecar = 2;
	public static int entrada = 1;
	public static int ganhou = 4;
	...
	public static int framesEntrada = 0;
	public static int framesMaxEntrada = 250;
		...
		if(game_State == "NORMAL") {
			if(Game.estado_cena == Game.jogando) {
				...
				if(Game.estado_cena == Game.entrada) {
					framesEntrada++;
					if(framesEntrada < framesMaxEntrada) {
						Sound.music.loop();
					}
					if(framesEntrada == framesMaxEntrada) {
