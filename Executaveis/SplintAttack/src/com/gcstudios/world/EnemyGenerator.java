	...
	public void tick() {
		...
		if (Game.levelGame == 1) {//INIMIGOS LEVEL 1
			...
			if (time1 == maxTime1) {
				...
				Enemy2 enemy2 = new Enemy2(posicao2, 0, 16, 16, 0.4, Game.spritesheet.getSprite(0, 64, 16, 16));
			...
			if (time11 == maxtime11) {
				int posicao2 = Entity.rand.nextInt(120 - 2) + 2;
				Enemy2 enemy2 = new Enemy2(posicao2, 0, 16, 16, 0.8, Game.spritesheet.getSprite(0, 64, 16, 16));
				Game.inimigos.add(enemy2);
				time11 = 0;
			}
		}
		if (Game.levelGame == 3) {// Verificação de level no UI
			...
			if (timeE1 == maxTimeE) {
				...
				Enemy enemyX = new Enemy(posicao1, 0, 16, 14, 0.7, Game.spritesheet.getSprite(0, 46, 16, 14));
				Sound.eagle.play();
			...
			if (timeE2 == maxTimeE2) {
				int posicao1 = Entity.rand.nextInt(110 - 2) + 2;
				Enemy enemyX = new Enemy(posicao1, 0, 16, 14, 1.3, Game.spritesheet.getSprite(0, 46, 16, 14));
				Sound.eagle4.play();
				Game.inimigos.add(enemyX);
				timeE2 = 0;
			}
